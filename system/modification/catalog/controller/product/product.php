...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$this->document->setTitle($product_info['name']. ' купить в Украине с доставкой, цена в интернет-магазине Статус Сервис');
			$this->document->setDescription('Купить '.$product_info['name'].' в интернет-магазине Статус Сервис.$ Лучшая цена!✈ Доставка по Украине. ☑ Фото, описание, отзывы. ☎ 099-174-03-73');
