<footer id="footer"><?php echo $text_footer; ?><br /><?php echo $text_version; ?></footer></div>
            ...
            <script>
				...
				$(document).ready(function(){
					// Page Products
					setTranslit("product_description\\[2\\]\\[name\\]", "keyword", false);
					// Page Info Articles
					setTranslit("information_description\\[2\\]\\[title\\]", "keyword", false);
					// Page Categories
					setTranslit("category_description\\[2\\]\\[name\\]", "keyword", false);
					// Page Manufacturer
					setTranslit("manufacturer_description\\[2\\]\\[name\\]", "keyword", false);
				});
            </script>
