    ...
    <div id="content" class="<?php echo $class; ?>">
		...
		<?php echo $content_top; ?>
		 <h2 class="page-title"><?php echo $heading_title; ?></h2>
			...
			<div class="row">
			 <?php if ($news['image']) { ?>
				<div class="col-md-2 col-sm-3 text-center"><a href="<?php echo $news['view']; ?>"><img src="<?php echo $news['image']; ?>" /></a></div>
			 ...
			 <? } else { ?>
				<div class="col-xs-12">
					...
					<div class="news-date"><?php echo $news['date_added']; ?></div>
					<div class="news-descr"><?php echo $news['description']; ?></div>
					<a href="<?php echo $news['view']; ?>" class="btn btn-primary">Читать далее</a>
				</div>
			  <? } ?>
			</div>
			</div>
