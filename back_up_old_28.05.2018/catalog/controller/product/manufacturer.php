	...
	public function index() {
		...
		foreach ($results as $result) {
			if($result['image']) {
				...
				$result['image'] = $this->model_tool_image->resize('placeholder.png', 100, 100);
			}
	...
	public function info() {
		...
		if ($manufacturer_info) {
			...
			if($manufacturer_info['image']) {
				$manufacturer_info['image'] = $this->model_tool_image->resize($manufacturer_info['image'], 100, 100);
			} else {
				$manufacturer_info['image'] = $this->model_tool_image->resize('placeholder.png', 100, 100);
			}
