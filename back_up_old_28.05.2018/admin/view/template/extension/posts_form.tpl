  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
				<label class="col-sm-2 control-label" for="input-meta-description<?php echo $language['language_id']; ?>"><?php echo $text_description; ?></label>
				<div class="col-sm-10">
				  <textarea name="posts[<?php echo $language['language_id']; ?>][meta_description]" placeholder="<?php echo $text_description; ?>" id="input-meta-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($posts[$language['language_id']]) ? $posts[$language['language_id']]['meta_description'] : ''; ?></textarea>
				</div>
			  </div>
        <div class="form-group">
				<label class="col-sm-2 control-label" for="input-meta-keywords<?php echo $language['language_id']; ?>"><?php echo $text_keyword; ?></label>
				<div class="col-sm-10">
				  <textarea name="posts[<?php echo $language['language_id']; ?>][meta_keywords]" placeholder="<?php echo $text_description; ?>" id="input-meta-keywords<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($posts[$language['language_id']]) ? $posts[$language['language_id']]['meta_keywords'] : ''; ?></textarea>
				</div>
			  </div>
			</div>
			<?php } ?>
		  ...
		  <div class="form-group">
			<label class="col-sm-2 control-label" for="input-keyword">ЧПУ</label>
			<div class="col-sm-10">
