...
<option value="<?php echo $key;?>" <?php if($cosyone_header_wishlist==$key) { echo " selected"; }?> ><?php echo $cosyone_header_wishlist_list;?></option>
    ...
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo $cosyone_top_promo_message[$language['code']]; ?>" name="cosyone_top_promo_message[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo $cosyone_custom_menu_title1[$language['code']]; ?>" name="cosyone_custom_menu_title1[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo $cosyone_custom_menu_title2[$language['code']]; ?>" name="cosyone_custom_menu_title2[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    <span class="help-block">* Leave it blank to disable the link</span>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo $cosyone_custom_menu_block_title[$language['code']]; ?>" name="cosyone_custom_menu_block_title[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo $cosyone_text_ql[$language['code']]; ?>" name="cosyone_text_ql[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
   ...
   <select name="cosyone_grid_related" class="form-control">
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo $cosyone_footer_custom_block_title[$language['code']]; ?>" name="cosyone_footer_custom_block_title[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo $cosyone_cookie_text[$language['code']]; ?>" name="cosyone_cookie_text[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo $cosyone_cookie_button_readmore[$language['code']]; ?>" name="cosyone_cookie_button_readmore[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo $cosyone_cookie_button_accept[$language['code']]; ?>" name="cosyone_cookie_button_accept[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo $cosyone_ie_text[$language['code']]; ?>" name="cosyone_ie_text[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>
    ...
    <?php foreach ($languages as $language) { ?>
    <div class="input-group"><span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
   	<input type="text" class="form-control" value="<?php echo $cosyone_ie_update_text[$language['code']]; ?>" name="cosyone_ie_update_text[<?php echo $language['code']; ?>]" />
    </div>
	<?php } ?>
    </div>    
